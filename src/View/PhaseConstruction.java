        ...
        for (int i = 0; i < 9; i++) {
            switch (jeu.principale.get(0, i)) {
                case Noir:
                    ...
                    drawable.drawImage(noir, debut_zone_gauche + (taille_cube + taille_cube / 10) * i, debut_zone_haut,
                            taille_cube, taille_cube, null);
                    break;
                case Bleu:
                    // System.out.println("bleu");
                    drawable.drawImage(bleu, debut_zone_gauche + (taille_cube + taille_cube / 10) * i, debut_zone_haut,
                            taille_cube, taille_cube, null);
                    break;
                case Blanc:
                    // System.out.println("blanc");
                    drawable.drawImage(blanc, debut_zone_gauche + (taille_cube + taille_cube / 10) * i, debut_zone_haut,
                            taille_cube, taille_cube, null);
                    break;
                case Rouge:
                    // System.out.println("rouge");
                    drawable.drawImage(rouge, debut_zone_gauche + (taille_cube + taille_cube / 10) * i, debut_zone_haut,
                            taille_cube, taille_cube, null);
                    break;
                case Jaune:
                    // System.out.println("jaune");
                    drawable.drawImage(jaune, debut_zone_gauche + (taille_cube + taille_cube / 10) * i, debut_zone_haut,
                            taille_cube, taille_cube, null);
                    break;
                case Vert:
                    // System.out.println("vert");
                    drawable.drawImage(vert, debut_zone_gauche + (taille_cube + taille_cube / 10) * i, debut_zone_haut,
                            taille_cube, taille_cube, null);
                    break;
                case Neutre:
                    // System.out.println("neutre");
                    drawable.drawImage(neutre, debut_zone_gauche + (taille_cube + taille_cube / 10) * i,
                            debut_zone_haut, taille_cube, taille_cube, null);
                    break;
                default:
                    break;
            }
        ...
        for (int x = 0; x < 6; x++) {
            for (int y = 0; y <= x; y++) {
                ...
                y_haut = debut_zone_gauche + x * (taille_cube + taille_cube / 10) / 2
                        + (taille_cube + taille_cube / 10) * (6 - y);
